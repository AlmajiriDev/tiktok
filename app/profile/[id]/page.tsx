...
export default function Profile({ params }: ProfilePageTypes) {
  ...
  return (
    ...
    <EditProfileOverlay/>
      <MainLayout>
        <div className="pt-[90px] ml-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 w-[calc(100%-90px)] pr-3 max-w-[1000px] 2xl:mx-auto md:mt-10">
          <div className="flex w-[calc(100vw-230px)]">
            <ClientOnly>
              {true ? (
                <img
                  className="w-[100px] min-w-[100px] rounded-full"
            ...
            <div className="ml-5 w-full">
              ...
              {true ? (
                ...
                <button className="flex items-center rounded-md py-1.5 px-8 mt-3 text-[15px] text-white font-semibold bg-[#f82c56]">
                  Follow
                </button>
              )}
            </div>
