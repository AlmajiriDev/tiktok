...
export default function EditProfileOverlay() {
  ...
  return (
    ...
    >
      <div
        className={`relative bg-white w-full max-w-[700px] sm:h-[500px] h-[655px] mx-3 p-4 rounded-lg mb-18 {${!uploadedImage} ? 'h-[855px] : 'h-[580px]`}
      >
        <div className="absolute flex items-center justify-between w-full p-5 left-0 top-5 border-b border-b-gray-300">
        ...
        >
          {!uploadedImage ? (
            <div>
              ...
              >
                <h3 className="font-semibold text-[15px] sm:mb-6 mb-1 text-gray-700 sm:w-[160px] sm:text-left text-center">
                  Profile photo
                </h3>
