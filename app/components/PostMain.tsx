    ...
    <>
      ...
      <div className="pl-3 w-full px-4 ">
        <div className="flex items-center justify-between pb-0.5">
          ...
          <button className="border text-[15px] px-[21px] py-0.5 border-[#F02C56] text-[#F02C56] font-semibold rounded-md">
            Follow
          </button>
        </div>
        <p className="text-[15px] pb-0.5 break-words md:max-w-[400px]">{post.text}</p>
