          ...
          <div className="mt-8 md:flex gap-6">
            {!fileDisplay ? (
              ...
              >
                ...
                <label
                  className="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#f82c56] rounded-sm cursor-pointer"
                  htmlFor="fileInput"
                >
                  Select a file
                </label>
              ...
              >
                {isUploading ? (
                  <div className="absolute flex w-full items-center justify-center z-20 bg-black h-full rounded-[50px] bg-opacity-50">
                ...
                <video
                  ...
                  loop
                  muted
                  className="abolute rounded-xl object-cover z-10 p-[13px] w-full h-full"
                  src={fileDisplay}
                />

                <div className="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p-2 border-e-gray-300">
            ...
            <div className="mt-4 mb-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-10 py-2.5 mt-8 border text-[16px] text-white bg-[#f82c56] rounded-sm"
                >
